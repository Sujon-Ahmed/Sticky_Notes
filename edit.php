...
$id = $_GET['id'];
$edit_notes = "SELECT * FROM `notes` WHERE id = $id";
$qry = mysqli_query($connection, $edit_notes);
$after_assoc = mysqli_fetch_assoc($qry);
?>
<!doctype html>
<html lang="en">
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <header>
                    <h4><a href="index.php" class="text-light fw-bolder text-decoration-none">Sticky Notes</a></h4>
            ...
            <div class="col-md-6">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="update_note_action.php" method="POST">
                            <div class="form-floating">
                                <textarea class="form-control" name="note" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"><?= $after_assoc['notes'] ?></textarea>
                                <label for="floatingTextarea2" class="text-dark"><i class="fa fa-pencil"></i> Edit Notes</label>
                            </div>
